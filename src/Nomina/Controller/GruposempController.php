...
class GruposempController extends AbstractActionController
{
    ...
    private $tlis = "Grupos de empleados"; // Titulo listado
    private $tfor = "Grupos de empleados"; // Titulo formulario
    private $ttab = "Tipo de empleado, Personal"; // Titulo de las columnas de la tabla
    ...
    public function listAction()
    {
      ...
      (
        "titulo"    =>  $this->tlis,
        "datos"     =>  $d->getGeneral("select * from n_tipemp"),            
        "ttablas"   =>  $this->ttab,
        "lin"       =>  $this->lin
      );                
   ...
   { 
      ...
      (
           ...
           'id'      => $id,          
           'datos'   => $d->getGeneral("select b.id, a.idTemp, a.fecing, a.CedEmp, a.nombre, a.apellido  
                                          from a_empleados a 
                                              inner join n_tipemp_p b on b.idEmp = a.id 
                                              where a.idTemp=".$id),
           "ttablas" =>  "Cedula, Nombres y apellidos, Fecha de ingreso, Fecha grupo, Editar",                   
           "lin"     => $this->lin
      );       
