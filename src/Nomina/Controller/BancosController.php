...
class BancosController extends AbstractActionController
{
    ...
    private $tlis = "Formas de pagoBancos"; // Titulo listado
    private $tfor = "Actualización banco"; // Titulo formulario
    private $ttab = "Bancos,Editar,Eliminar"; // Titulo de las columnas de la tabla
    ...
    public function listAction()
    {
        ...
        $u=new Bancos($this->dbAdapter); // ---------------------------------------------------------- 1 FUNCION DENTRO DEL MODELO (C)
        $valores=array
        (
            "titulo"    =>  $this->tlis,
            "datos"     =>  $u->getRegistro(),            
